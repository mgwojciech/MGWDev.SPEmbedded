...
import { IMsalAuthenticationConfig, Msal2AuthenticationService } from "mgwdev-m365-helpers/lib/services/Msal2AuthenticationService";
...
export const AuthenticationContextProvider = (props: IAuthenticationContextProviderProps) => {
    ...
    return (
        authProvider && <AuthenticationContext.Provider value={{
